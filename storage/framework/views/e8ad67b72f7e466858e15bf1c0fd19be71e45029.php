...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            <label for="nombreDeUsuario" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nombre de usuario')); ?></label>

                            <div class="col-md-6">
                                <input id="nombreDeUsuario" type="text" class="form-control <?php if ($errors->has('nombreDeUsuario')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('nombreDeUsuario'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="nombre_de_usuario" value="<?php echo e(old('nombreDeUsuario')); ?>" autocomplete="nombreDeUsuario" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maru\Desktop\ultimate_quizz\digitalhouse1-master\resources\views/auth/register.blade.php ENDPATH**/ ?>