  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="RegisterController.php">Register <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="LoginController.php">Login</a>
      </li>
      <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\proyecto\ultimate_quizz\resources\views/sitio.blade.php ENDPATH**/ ?>